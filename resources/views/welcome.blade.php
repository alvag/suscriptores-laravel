<x-guest-layout>
    <div class="bg-indigo-900 flex flex-col h-screen">
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex w-1/3 flex-col items-start">
                ...
                <p class="text-indigo-200 text-xl mb-10">We are just checking <span class="font-bold underline">TALL stack</span>. Would you mind subscribing?</p>
    ...
    <div class="bg-pink-500 flex flex-col w-full h-screen">
